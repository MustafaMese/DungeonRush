...
namespace UsingTheirs.RemoteInspector
{
    ...
    public class ServerHttpJsonPost : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            Logger.Log("[HttpJsonPostServer] Listening " + listenPort + " ...");
        }
        ...
        void OnDestroy()
        {
            if (httpListener != null)
            {
                ...
                Logger.Log("[HttpJsonPostServer] Stop Listening " + listenPort + " ...");
            }
        }
        ...
        void ListenerCallback(IAsyncResult result)
        {
            ...
            Logger.Log("[HttpJsonPostServer] req.Url.AbsolutePath = " + req.Url.AbsolutePath);
        ...
        void HandleRequest(HttpListenerRequest req, HttpListenerResponse res, Handler handler)
        {
            ...
            SendMainThreadJob(() =>
           {
               ...
               Logger.Log("[HttpJsonPostServer] url:{0}, res:{1}", req.Url.AbsolutePath, jsonResponse);
